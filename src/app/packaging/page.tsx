...
import { LayoutDashboard, ShoppingCart, Package, ClipboardList, Truck, Calculator, PackageSearch, Warehouse, Database, Users, BarChart3, UserCircle, Shield, Settings, RefreshCw, Scale, Printer, CheckCircle } from 'lucide-react';
      ...
      <div className="flex" style={{ height: 'calc(100vh - 3.5rem)' }}>
        ...
        <main className="flex-1 min-w-0 overflow-y-auto bg-[#F6F8FB] p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 border border-[#E6EAF2]">
            <h3 className="text-base font-semibold text-[#152033] mb-4">待打包订单</h3>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button className="flex items-center gap-1 px-3 py-1.5 bg-[#2F6BFF] text-white rounded text-xs hover:bg-[#2F6BFF]/90">
                            <Printer className="w-3 h-3" />打印面单
                          </button>
