...
import { LayoutDashboard, ShoppingCart, Package, ClipboardList, Truck, Calculator, PackageSearch, Warehouse, Database, Users, BarChart3, UserCircle, Shield, Settings, RefreshCw, Plus } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/wms', icon: Warehouse, label: '仓库管理', active: true },
