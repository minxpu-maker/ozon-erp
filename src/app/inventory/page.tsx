...
import { PackageSearch, RefreshCw, Plus, Search } from 'lucide-react';
...
export default function InventoryPage() {
  ...
  return (
    <AppLayout title="库存管理" subtitle="轻量化库存管理 · 热销产品备货建议">
      {/* 工具栏 */}
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 border border-[#E6EAF2]">
        ...
        {loading ? (
          ...
          <div className="text-center py-8 text-[#637089]">暂无库存数据</div>
        ) : (
